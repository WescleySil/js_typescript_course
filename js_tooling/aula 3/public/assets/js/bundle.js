...
(function () {
  ...
  var botaoGerar = document.querySelector('.container button');
  var botaoCopiar = document.querySelector('.botao-copiar');
  var botaoValidar = document.querySelector('.botao-validar');
  var cpfParaValidar = document.querySelector('#cpf');
  var resultadoValidacao = document.querySelector('.cpf-validado');
  ...
  botaoValidar.addEventListener('click', function () {
    ...
    var validador = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_1__["default"](cpfParaValidar.value);
    if (validador.valida()) {
  ...
  function copiarTexto() {
    return _copiarTexto.apply(this, arguments);
  }
  function _copiarTexto() {
    _copiarTexto = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            _context.p = 0;
            _context.n = 1;
            return navigator.clipboard.writeText(cpfGerado.innerText);
          case 1:
          ...
          case 2:
            _context.p = 2;
            _t = _context.v;
            alert("Falha ao copiar texto: ".concat(_t));
          case 3:
            return _context.a(2);
        }
      }, _callee, null, [[0, 2]]);
